  ...
  <head>
    ...
    <style>
      ...
      #scatterContainer {
        ...
        margin-top: -65px; /* Reduce gap between map and scatter plot */
      }
    </style>
  </head>
  <body>
      ...
      function initializeCharts(mapPoints, areaMapping) {
        ...
        $.getJSON(
          ...
          function (geoJson) {
            ...
            mapOption = {
              title: {
                text: "Map of Guangzhou, Shenzhen, Foshan, and Dongguan", // Title text
                left: "center", // Position the title in the center at the top
                top: -2,
                textStyle: {
                  fontSize: 12, // Reduce font size here
                  // Other styling options for the title can be added here
                },
              },
              tooltip: {
                trigger: "item",
